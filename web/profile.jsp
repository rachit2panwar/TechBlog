            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class = "fa fa-cubes"></span>LearnCode On Youtube <span class="sr-only">(current)</span></a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="fa fa-pencil-square-o"></span> Categories
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle ="modal" data-target="#add-post-modal"><span class="fa fa-code"></span> Create a Post</a>
                    </li>
                </ul>
                ...
                $("#add-post-form").on("submit", function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            {
                                swal("Error!!", "Somethinggg went wrong try again...", "error");
                            }
                        },
